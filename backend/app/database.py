...
def _ensure_pg_columns() -> None:
    ...
    with engine.begin() as conn:
        ...
        for stmt in (
            ...
            "ALTER TABLE video_interviews ADD COLUMN IF NOT EXISTS recording_key VARCHAR DEFAULT ''",
            ...
            "ALTER TABLE hiring_requests ADD COLUMN IF NOT EXISTS hire_type VARCHAR DEFAULT ''",
